...
class Cart
{
	...
	public static function addProduct($id)
	{
		...
		//Проверяем какое количество одного товара необходимо добавить в корзину
		...
		if (array_key_exists($id, $productsInCart)) {
			...
			// Если нет, добавляем id нового товара в корзину с количеством равным $count
	...
	public static function getTotalPrice($products)
	{
		...
		//Возвращаем общую стоимость переданных товаров
		return $total;
	}
	...
	// Получаем массив с идентификаторами и количеством товаров в корзине
		...
		//если количество товара в корзине равно 0, то удаляем данный товар из корзины
