						...
						<div class="col-sm-6">
							<div class="contactinfo">
								<ul class="nav nav-pills">
									<li><a href="#"><i class="fa fa-phone"></i> +42 073 000 21 44</a></li>
									<li><a href="mailto:nicon-83@mail.ru"><i class="fa fa-envelope"></i>
										nicon-83@mail.ru</a>
									</li>
								</ul>
							</div>
						...
						<div class="col-sm-6">
							<div class="social-icons pull-right">
								<ul class="nav navbar-nav">
									...
									<li><a href="https://plus.google.com/collections/featured"><i
